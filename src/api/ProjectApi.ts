...
export default class ProjectApi extends AbstractApi {
  getProjects = async (): Promise<any> =>
    this.client.post(`/api/jobs/Get`).then((res) => JSON.parse(res.data));

  getProjectInitInfo = async (): Promise<any> =>
    this.client.get(`/api/jobs/initinfo`).then((res) => JSON.parse(res.data));

  getProjectById = async (params: { id: number }): Promise<any> =>
    this.client.post(`/api/job/get`, params).then((res) => res.data);
  ...
  getProjectQuoteInfo = async (params: {
    ...
    intJobID: number;
    intUnitNo: number;
  }): Promise<any> => this.client.post(`/api/quote/get`, params).then((res) => res.data);

  saveQuoteInfo = async (params: any): Promise<any> =>
    this.client.post(`/api/Quote/save`, params).then((res) => res.data);

  addNewMisc = async (params: any): Promise<any> =>
    this.client.post(`/api/Quote/addMisc`, params).then((res) => res.data);

  updateMisc = async (params: any): Promise<any> =>
    this.client.post(`/api/Quote/updateMisc`, params).then((res) => res.data);

  deleteMisc = async (params: any): Promise<any> =>
    this.client.post(`/api/Quote/deleteMisc`, params).then((res) => res.data);

  addNewNotes = async (params: any): Promise<any> =>
    this.client.post(`/api/Quote/addNotes`, params).then((res) => res.data);

  updateNotes = async (params: any): Promise<any> =>
    this.client.post(`/api/Quote/updateNotes`, params).then((res) => res.data);

  deleteNotes = async (params: any): Promise<any> =>
    this.client.post(`/api/Quote/deleteNotes`, params).then((res) => res.data);

  getSubmittalInfo = (params: any): Promise<any> =>
    this.client.post(`/api/Submittals/getAllData`, params).then((res) => res.data);

  addNewNote = (params: any): Promise<any> =>
    this.client.post(`/api/Submittals/noteadd`, params).then((res) => res.data);

  addNewShippingNote = (params: any): Promise<any> =>
    this.client.post(`/api/Submittals/shippingnoteadd`, params).then((res) => res.data);

  saveSubmittalInfo = (params: any): Promise<any> =>
    this.client.post(`/api/Submittals/save`, params).then((res) => res.data);

  getProjectNote = (params: any): Promise<any> =>
    this.client.post(`/api/units/getNotes`, params).then((res) => res.data);

  saveNotes = (params: any): Promise<any> =>
    this.client.post(`/api/units/saveNotes`, params).then((res) => res.data);

  addNewProject = (params: any): Promise<any> =>
    this.client.post(`/api/job/add`, params).then((res) => res.data);

  getAllBaseData = (): Promise<any> =>
    this.client.get(`/api/Selection/GetAll`).then((res) => JSON.parse(res.data));

  getUnitInfo = (prarms: any): Promise<any> =>
    this.client.post(`/api/units/GetUnitInfo`, prarms).then((res) => res.data);

  getSelectionInfo = (prarms: any): Promise<any> =>
    this.client.post(`/api/units/ViewSelection`, prarms).then((res) => res.data);

  saveUnitInfo = (prarms: any): Promise<any> =>
    this.client.post(`/api/units/Save`, prarms).then((res) => res.data);

  getFileList = (): Promise<any> =>
    this.client.post('/api/resource/getFiles').then((res) => res.data);
