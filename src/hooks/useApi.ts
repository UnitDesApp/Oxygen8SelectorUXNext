...
export const useGetSavedUnitNotes = (params: any, config?: UseQueryOptions<any, any, any, any>) => {
  const api = useApiContext();
  return useQuery<any>([`get-saved-unit-notes`, params], () => api.project.getSavedUnitNotes(params), config);
};


export const useGetUnitSelection = (params: any, config?: UseQueryOptions<any, any, any, any>) => {
  const api = useApiContext();
  return useQuery<any>([`get-unit-selection`, params], () => api.project.getUnitSelection (params), config);
};
