...
const {
  ...
  const {
    ...
    strSupplyAirOpening,
    intExhaustAirOpeningId,
    strExhaustAirOpening,
    intOutdoorAirOpeningId,
    strOutdoorAirOpening,
    intReturnAirOpeningId,
    strReturnAirOpening,
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      ddlUnitVoltageId: edit ? intVoltageId : 1,
      ...
      // Comp Opt Cust
      txbPreheatHWC_Cap: edit ? dblPreheatHWCCap || 0 : 0,
      txbPreheatHWC_FlowRate: edit ? dblPreheatHWCFlowRate || 0 : 0,
      txbCoolingCWC_Cap: edit ? dblCoolingCWCCap || 0 : 0,
      txbCoolingCWC_FlowRate: edit ? dblCoolingCWCFlowRate || 0 : 0,
      txbHeatingHWC_Cap: edit ? dblHeatingHWCCap || 0 : 0,
      txbHeatingHWC_FlowRate: edit ? dblHeatingHWCFlowRate || 0 : 0,
      txbReheatHWC_Cap: edit ? dblReheatHWCCap || 0 : 0,
      txbReheatHWC_FlowRate: edit ? dblReheatHWCFlowRate || 0 : 0,
      ...
      ddlSupplyAirOpeningId: edit ? intSupplyAirOpeningId : 0,
      ddlSupplyAirOpeningText: edit ? strSupplyAirOpening : '',
      ddlExhaustAirOpeningId: edit ? intExhaustAirOpeningId : 0,
      ddlExhaustAirOpeningText: edit ? strExhaustAirOpening : '',
      ddlOutdoorAirOpeningId: edit ? intOutdoorAirOpeningId : 0,
      ddlOutdoorAirOpeningText: edit ? strOutdoorAirOpening : '',
      ddlReturnAirOpeningId: edit ? intReturnAirOpeningId : 0,
      ddlReturnAirOpeningText: edit ? strReturnAirOpening : '',
      layoutImage: {},
    }),
    [
      edit,
